...
TMDB API를 활용하여 사용자가 설정한 조건(장르, 언어, 연도)에 맞는 영화를 탐색하고, 16강 토너먼트를 통해 최적의 영화를 선정하는 웹 애플리케이션입니다. 무한 스크롤을 통한 방대한 데이터 탐색과 인터랙티브한 월드컵 시스템을 제공하며, 최종 우승작은 명예의 전당에 기록됩니다.
